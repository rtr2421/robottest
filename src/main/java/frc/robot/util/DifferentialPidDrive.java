 ...
 * wheels per side (e.g., 6WD or 8WD). This class takes a WPI_TalonSRX per side.
 * For four and six motor drivetrains, construct and pass in
 ...
 * the same response.
 */
public class DifferentialPidDrive extends RobotDriveBase {
    ...
    private double targetRpm = RobotMap.TARGET_VELOCITY;
     ...
     */
    public DifferentialPidDrive(WPI_TalonSRX leftMotor, WPI_TalonSRX rightMotor) {
    ...
    private void verify(WPI_TalonSRX leftMotor, WPI_TalonSRX rightMotor) {
    ...
    public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
        ...
        m_leftMotor.set(ControlMode.Velocity, joystickToVelocity(leftSpeed * m_maxOutput));
        m_rightMotor.set(ControlMode.Velocity,
                joystickToVelocity(rightSpeed * m_maxOutput * m_rightSideInvertMultiplier));

        feed();
    }

    private double joystickToVelocity(double stick) {
        /**
         ...
         */
        double targetVelocity_UnitsPer100ms = stick * getTargetRpm() * RobotMap.TALON_ENCODER_PER_REV / 600;
    ...
    public String getDescription() {
        return "DifferentialPidDrive";
    }

    @Override
    public void initSendable(SendableBuilder builder) {
        builder.setSmartDashboardType("DifferentialPidDrive");
        ...
        builder.addDoubleProperty("TargetRPM", this::getTargetRpm, this::setTargetRpm);
    }
